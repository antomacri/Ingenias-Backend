...
-- PRACTICA 
-- 1
SELECT productID AS Codigo, productName AS Descripcion, QuantityPerUnit AS Presentacion, UnitPrice AS PrecioUnitario FROM northwind.products;
-- 2
SELECT productID AS Codigo, UCASE(productName) AS Descripcion, QuantityPerUnit AS Presentacion, UnitPrice AS PrecioUnitario FROM northwind.products;
-- 3 
SELECT 
    productID AS Codigo,
    UCASE(productName) AS Descripcion,
